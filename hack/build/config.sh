...
DOCKER_IMAGES="cmd/${CONTROLLER} cmd/${IMPORTER} cmd/${CLONER} cmd/${APISERVER} cmd/${UPLOADPROXY} cmd/${UPLOADSERVER} tools/${FUNC_TEST_INIT} tools/${FUNC_TEST_HTTP} cmd/${FUNC_TEST_REGISTRY}"
...
REGISTRY_IMAGE_NAME=${REGISTRY_IMAGE_NAME:-cdi-func-test-registry}
